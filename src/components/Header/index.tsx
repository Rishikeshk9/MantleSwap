...
import Logo from '../../assets/logos/mantle.png'
import LogoDark from '../../assets/logos/mantle.png'
    ...
    try {
      ...
      if (switchError.code === 4902) {
        try {
          ...
          //window.location.href = `http://localhost:3000/#/swap?chain=${nameofchain}&outputCurrency=BIT`
        } catch (addError) {
          // handle "add" error
          // history.replace({
  ...
  return (
    <HeaderFrame>
      ...
      <HeaderRow>
        <Title href=".">
          <UniIcon>
            <img style={{ borderRadius: '50px' }} width={'56px'} src={darkMode ? LogoDark : Logo} alt="logo" />
          </UniIcon>
        </Title>
        <HeaderLinks>
